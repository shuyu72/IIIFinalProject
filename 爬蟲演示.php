	...
	<div class="container animatedParent">
		<div class="row text-center">
			<div class="col-md-4 animated bounceInLeft slower">
				<div class="circle" onclick="location.href='Background.php'"><img src="images/brand.png"></div>
				<h4 class="service-heading">返回鍵</h4>
				<p class="text-muted" ></p></p>
			</div>
			<div class="col-md-4 animated bounceInDown slower">
				<div class="circle" onclick="window.open('/manage_news_CT.php','crawl_BBC.py');"><img src="images/email.png"></div>
				<h4 class="service-heading">新聞</h4>
				<p class="text-muted"   >
			</div>
			<div class="col-md-4 animated bounceInRight slower">
				<div class="circle" onclick="window.open('/manage_news_BBC.php','crawl_china_times6.py');"><img src="images/news.png"></div>
				<h4 class="service-heading">新聞BBC</h4>
				<p class="text-muted" ></p>
			</div>
			<div class="col-md-4 animated bounceInLeft slower">
				<div class="circle" onclick="window.open('/manage_update_stock.php','update_daily_final.py');"><img src="images/stockmaker.png"></div>
				<h4 class="service-heading">股票</h4>
				<p class="text-muted" ></p>
			</div>
