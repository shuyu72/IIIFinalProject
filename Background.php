	...
	<div class="container animatedParent">
		<div class="row text-center">
			<div class="col-md-4 animated bounceInLeft slower">
				<div class="circle"><img src="images/brand.png"></div>
				<h4 class="service-heading">返回/登出</h4>
				<p class="text-muted" onclick="location.href='/index.php'"  >
			</div>
			<div class="col-md-4 animated bounceInDown slower">
				<div class="circle" onclick="location.href='會員資料.php'"><img src="images/member.png"></div>
				<h4 class="service-heading">會員資料</h4>
				<p class="text-muted"    >
			</div>
			<div class="col-md-4 animated bounceInRight slower">
				<div class="circle" onclick="location.href='AI預測範例.php'"><img src="images/ai.png"></div>
				<h4 class="service-heading">AI分析預測</h4>
				<p class="text-muted"  > </p>
			</div>
			<div class="col-md-4 animated bounceInLeft slower">
				<div class="circle" onclick="location.href='爬蟲演示.php'"><img src="images/news.png"></div>
				<h4 class="service-heading">新聞/股票爬蟲</h4>
				<p class="text-muted"  ></p>
			</div>
